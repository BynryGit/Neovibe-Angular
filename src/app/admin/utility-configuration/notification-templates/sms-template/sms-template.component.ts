...
export class SmsTemplateComponent implements OnInit {
  ...
  var text = tinymce.get("mymce2").getContent();
  console.log(text)
  let data ={
    template:text,
                      ...
                      return [
                        {
                          ...
                          text: 'Name',
                          onAction: function () {
                            editor.insertContent('&nbsp;<em>{Utility.first_name}</em>');
                          }
                        },
                        {
                          type: 'menuitem',
                          text: 'Email',
                          onAction: function () {
                            editor.insertContent('&nbsp;<em>{Utility.email}</em>');
                          }
                        },
                        {
                          type: 'menuitem',
                          text: 'Tax ID',
                          onAction: function () {
                            editor.insertContent('&nbsp;<em>{Utility.tax_id}</em>');
                          }
                        },
                      ];
                    }
