...
@Component({
  selector: 'app-consumer-filters',
  templateUrl: './consumer-filters.component.html',
  styleUrls: ['./consumer-filters.component.scss']
})
export class ConsumerFiltersComponent implements OnInit {
