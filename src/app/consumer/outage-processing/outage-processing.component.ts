...
@Component({
  selector: 'app-outage-processing',
  templateUrl: './outage-processing.component.html',
  styleUrls: ['./outage-processing.component.scss']
})
export class OutageProcessingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.apiService.get(`work-order/service-appointment/list?utility_id_string=`+this.utilityIdString+`&Outage_processing=True&page=${page}&page_size=${this.dtOptions.pageLength}`).subscribe(data => {
    ...
    // API For Consumer service contract details List End
        ...
        this.dtOptions1 = {
          ...
          ajax: (dataTablesParameters: any, callback) => {
            ...
            that.apiService.get(`work-order/service-appointment/list?utility_id_string=`+this.utilityIdString+`&Outage_processing_history=True&page=${page}&page_size=${this.dtOptions1.pageLength}`).subscribe(data => {
