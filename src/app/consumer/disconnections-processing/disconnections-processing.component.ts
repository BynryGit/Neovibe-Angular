...
@Component({
  selector: 'app-disconnections-processing',
  templateUrl: './disconnections-processing.component.html',
  styleUrls: ['./disconnections-processing.component.scss']
})
export class DisconnectionsProcessingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        that.apiService.get(`work-order/service-appointment/list?utility_id_string=`+this.utilityIdString+`&Disconnect_processing=True&page=${page}&page_size=${this.dtOptions.pageLength}`).subscribe(data => {
    ...
    // API For Consumer service contract details List End
        ...
        this.dtOptions1 = {
          ...
          ajax: (dataTablesParameters: any, callback) => {
            ...
            that.apiService.get(`work-order/service-appointment/list?utility_id_string=`+this.utilityIdString+`&Disconnect_processing_history=True&page=${page}&page_size=${this.dtOptions1.pageLength}`).subscribe(data => {
                // this.consumerList = data;
