...
@Component({
  selector: 'app-dispatch-reading-filter',
  templateUrl: './dispatch-reading-filter.component.html',
  styleUrls: ['./dispatch-reading-filter.component.scss']
})

export class DispatchReadingFilterComponent implements OnInit {
